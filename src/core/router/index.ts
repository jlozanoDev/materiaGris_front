...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    meta: { requiresAuth: true, permissions: 'admin.report-template.view' },
  },
  {
    ...
    meta: { requiresAuth: true, permissions: 'admin.report-template.create' },
  },
  {
    path: "/admin/report-templates/:id/editar",
    name: "AdminReportTemplateEdit",
    component: () => import("@/modules/admin/report-template/presentation/pages/ReportTemplateBuilderPage.vue"),
    meta: { requiresAuth: true, permissions: 'admin.report-template.edit' },
  },
  {
    path: "/informes",
    name: "ReportList",
  ...
  },
  {
    ...
    meta: { requiresAuth: true, permissions: ['reports.edit'] },
  },
  {
    path: "/pacientes/:id/informe/nuevo",
    name: "ReportCreate",
    component: () => import("@/modules/reports/presentation/pages/ReportFillPage.vue"),
    meta: { requiresAuth: true, permissions: 'reports.create' },
  },
