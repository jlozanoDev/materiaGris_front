import type { PatientRepository, PatientSearchFilters } from "@/modules/patients/domain/repositories/PatientRepository";
import { fetchClient } from "@/core/api/httpClient";

export default class ApiPatientRepository implements PatientRepository {
  async search(filters: PatientSearchFilters = {}): Promise<any> {
