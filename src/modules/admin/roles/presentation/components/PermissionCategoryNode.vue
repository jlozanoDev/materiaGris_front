...
<template>
  <div
    class="border border-slate-200 rounded-xl overflow-hidden bg-white shadow-sm transition-all duration-300 mb-3"
    :class="[expanded ? 'ring-1 ring-indigo-100 shadow-md' : '', depth > 0 ? 'ml-4 mt-2' : '']"
  >
    <!-- Header -->
    <button
      type="button"
    ...
    >
      <div class="flex items-center gap-3">
        <div class="w-6 h-6 rounded-lg bg-indigo-50 flex items-center justify-center">
          <i
            class="pi text-[10px] text-indigo-600 transition-transform duration-300"
    ...
    <div v-show="expanded" class="animate-fade-in pb-2">
      ...
      <div class="divide-y divide-slate-100">
        ...
        >
          ...
          <div
            class="flex items-center gap-1 bg-slate-100 p-1 rounded-xl border border-slate-200 shadow-inner"
          >
            <button
              type="button"
              title="Permitir"
